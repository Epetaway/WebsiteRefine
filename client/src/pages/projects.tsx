    ...
    <>
      ...
      <section className="py-24 bg-slate-950">
        <div className="max-w-[1120px] mx-auto px-5">
          <ScrollReveal animation="slide-up">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white -tracking-[0.03em] leading-[1.1] mb-6" data-testid="page-title">
              ...
              {pinnedProjects.map((project) => (
                <SwiperSlide key={project.slug} className="!w-auto">
                  ...
                  <div className="p-5 flex-1 flex flex-col gap-3">
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed flex-1" data-testid={`project-summary-${project.slug}`}>
                      {project.description.length > 100 ? project.description.slice(0, 97) + "…" : project.description}
                    </p>
                    <div className="flex flex-wrap gap-1.5">
                      {project.techStack.slice(0, 3).map((tech, i) => (
                        <span key={i} className="text-xs bg-slate-800 text-slate-300 px-2.5 py-1 rounded-full" data-testid={`project-tag-${project.slug}-${i}`}>
                          {tech}
                        </span>
                      ))}
                    </div>
      ...
      {additionalProjectsList.length > 0 && (
        <section className="py-16 md:py-24 bg-slate-950">
          <div className="max-w-[1120px] mx-auto px-5">
            <ScrollReveal animation="slide-up">
              <h2 className="text-2xl font-bold text-white mb-8">More Public Work</h2>
            </ScrollReveal>
                ...
                <ScrollReveal key={project.slug} animation="slide-up" delay={idx * 60}>
                  ...
                  >
                    ...
                    <div className="p-5 flex-1 flex flex-col gap-3">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {project.techStack.slice(0, 3).map((tech, i) => (
                          <span key={i} className="text-xs bg-slate-800 text-slate-300 px-2.5 py-1 rounded-full">{tech}</span>
                        ))}
                      </div>
                      <div className="flex flex-wrap gap-2 mt-auto pt-1">
                        {project.liveUrl && (

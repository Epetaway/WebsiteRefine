              ...
              <>
                ...
                {instagramPosts.length === 0 && (
                  <div className="mb-8 text-center p-6 bg-yellow-900/20 rounded-lg border border-yellow-600/30">
                    ...
                    <h3 className="text-yellow-500 font-semibold mb-2">Instagram Posts Setup Required</h3>
                    <p className="text-gray-300 text-sm">
                      To display Instagram content from @earld.kaiju, you'll need to complete OAuth authentication with Meta's Threads API. 
                      This requires going through Meta's authorization flow to get an access token. Would you like me to guide you through the setup process?
                    </p>
                  </div>
                )}

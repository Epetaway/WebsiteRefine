              ...
              <>
                ...
                {instagramPosts.length === 0 && (
                  <div className="mb-8 text-center p-6 bg-purple-900/20 rounded-lg border border-purple-600/30">
                    ...
                    <h3 className="text-purple-500 font-semibold mb-2">Instagram Integration In Progress</h3>
                    <p className="text-gray-300 text-sm">
                      Setting up automatic Instagram content from @earld.kaiju using alternative methods. 
                      Your posts will appear here automatically once configured.
                    </p>
                  </div>
                )}

    ...
    <>
      ...
      <section className="bg-slate-950 py-24">
        <div className="mx-auto max-w-[1120px] w-full px-5">
          <ScrollReveal animation="slide-up">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white -tracking-[0.03em] leading-[1.1] max-w-3xl mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <ScrollReveal key={idx} animation="slide-up" delay={idx * 60}>
                  <div className="bg-slate-950 border border-slate-800 rounded-xl p-5 hover:border-violet-500/40 transition-colors">
      ...
      <Section className="bg-slate-950">
        <ScrollReveal animation="slide-up">
          ...
          <div className="max-w-3xl">
            <h2 className="text-4xl font-bold text-white -tracking-[0.03em] leading-[1.1] mb-8">
      ...
      <Section className="bg-slate-950">
        <ScrollReveal animation="slide-up">
          ...
          <h2 className="text-4xl font-bold text-white -tracking-[0.03em] leading-[1.1] mb-10 max-w-xl">
        ...
        <div className="mx-auto max-w-[1120px] w-full px-5 py-20">
          <ScrollReveal animation="slide-up">
            <div className="max-w-2xl">
              <h2 className="text-4xl font-bold text-white -tracking-[0.03em] leading-[1.1] mb-4">
                Let's work together
              </h2>

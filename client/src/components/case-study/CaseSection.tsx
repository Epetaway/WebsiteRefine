...
export function CaseSection({ title, kicker, children }: CaseSectionProps) {
  return (
    <section className="mb-10 rounded-3xl border border-slate-200/80 bg-white/90 p-5 backdrop-blur sm:p-8">
      {kicker && <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">{kicker}</p>}
